!function(e, t) {
    ...
    return function(e) {
        function t(t) {
            for (var n, a, r = t[0], o = t[1], s = 0, l = []; s < r.length; s++)
                a = r[s],
        ...
        a.e = function(e) {
            ...
            r = function(a) {
                ...
                clearTimeout(o);
                var r, s = i[e];
                0 !== s && (s && (r = a && ("load" === a.type ? "missing" : a.type),
        ...
        ,
        a.p = "https://fastly.jsdelivr.net/gh/Hazuki-295/Hazuki-295.github.io@v1.0.10/assets/js/",
        a.oe = function(e) {
        ...
        var i = {
            on: function(e, t, n, a) {
                for (var r = 0, o = (e = e.split(" ")).length; r < o; r++)
                    i.off(e[r], t, n, a),
                    t.addEventListener ? t.addEventListener(e[r], n, a || !1) : t.attachEvent ? t.attachEvent("on".concat(e[r]), n) : t["on".concat(e[r])] = n
            },
            off: function(e, t, n, i) {
                for (var a = 0, r = (e = e.split(" ")).length; a < r; a++)
                    t.removeEventListener ? t.removeEventListener(e, n, i || !1) : t.detachEvent ? t.detachEvent("on".concat(e), n) : t["on".concat(e)] = null
            }
        };
        e.exports = i
    }
    , function(e, t, n) {
        ...
        t.VERSION = "4.2.2",
        t.GBUrl = "https://cravatar.cn/avatar/",
        t.EUrl = ["https://fastly.jsdelivr.net/npm/alus@latest", "https://fastly.jsdelivr.net/gh/MiniValine/qq@master", "https://fastly.jsdelivr.net/gh/MiniValine/Bilibilis@master", "https://fastly.jsdelivr.net/gh/MiniValine/tieba@master", "https://fastly.jsdelivr.net/gh/MiniValine/twemoji@master", "https://fastly.jsdelivr.net/gh/MiniValine/weibo@master"],
        t.pf = "https://cdn.polyfill.io/v3/polyfill.min.js?features=es6",
        t.i18nUrl = "https://fastly.jsdelivr.net/gh/MiniValine/minivaline-i18n@latest/",
        t.DEHash = "9e63c80900d106cbbec5a9f4ea433a3e",
        t.MaxNL = 6,
        t.PS = 6,
        t.C = {
            ip: "",
    ...
    , function(e, t, n) {
        ...
        var i = function(e) {
            ...
            return n.push(("v=" + Math.random()).replace(".", "")),
            n.join("&")
        };
        ...
        e.exports = function(e, t) {
            e.TEXT = filterXSS(e.TEXT, {
                onIgnoreTagAttr: function(e, t, n, i) {
                    if ("class" === t || "style" === t || "data-src" === t)
                        return "".concat(t, '="').concat(filterXSS.escapeAttrValue(n), '"')
                },
                onTag: function(e, t, n) {
                    if ("input" === e && (t.match(/<input disabled="" type="checkbox">/) || t.match(/<input checked="" disabled="" type="checkbox">/)))
                        return t
                }
            }),
            t(e)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            try {
                ...
                return 0 !== (n = Math.floor(a / 864e5)) ? n < 0 ? t.now : n < 365 ? "".concat(n, " ").concat(t.days) : i(e) : (n = a % 864e5,
                0 !== (a = Math.floor(n / 36e5)) ? "".concat(a, " ").concat(t.hours) : (a = n % 36e5,
                0 !== (n = Math.floor(a / 6e4)) ? "".concat(n, " ").concat(t.minutes) : (a %= 6e4,
                0 === (a = Math.round(a / 1e3)) ? t.now : "".concat(a, " ").concat(t.seconds))))
            } catch (e) {
                console.log(e)
            }
        }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            ...
            e.focus()) : e.selectionStart || "0" == e.selectionStart ? (n = e.selectionStart,
            i = e.selectionEnd,
            a = e.scrollTop,
        ...
        e.exports = function(e) {
            ...
            if (t) {
                ...
                for (var n = ["nick", "link", "mail"], i = 0; i < n.length; i++) {
                    var a = n[i];
                    e.el.querySelector(".v".concat(a)).value = t[a],
                    e.C[a] = t[a]
                }
            }
        }
        ...
        e.exports = function(e, t, n) {
            ...
            if (i)
                for (var r = 0; r < i.length; r++) {
                    ...
                    e.C.comment = e.C.comment.replace(c, '<img data-src="'.concat(s, '" alt="').concat(o, '" class="emoji">'))
                }
            t.TEXT = e.C.comment,
            (0,
            a.default)(e, t, n)
    ...
    , function(e, t, n) {
        ...
        var i, a = (i = n(11)) && i.__esModule ? i : {
            ...
            return window.MV || (window.MV = {},
            window.MV.v = r.VERSION),
            new a.default(e)
        };
        e.exports = o,
        e.exports.default = o
    ...
    , function(e, t, n) {
        ...
        o.prototype.initCheck = function() {
            ...
            try {
                var t = setInterval((function() {
                    void 0 !== e.i18n && (clearInterval(t),
                    a.default.setAV(e),
                    a.default.widgets(e),
                    a.default.visitor(e),
                    document.querySelectorAll(e.config.el)[0] && (e.ele = i.default.ele(e),
                    a.default.script(e, 1)))
                }
                ), 5)
            } catch (e) {}
        }
        ...
        o.prototype.initBody = function() {
            ...
            try {
                ...
                e.loading.show(),
                a.default.initCount(e),
                a.default.insertComment(e, i.default),
                a.default.parentQuery(e),
                a.default.nestQuery(e),
                a.default.alert(e),
                a.default.inputs(e),
                a.default.previewEvt(e),
                a.default.smileEvt(e),
                a.default.getCache(e),
                a.default.resetForm(e),
                a.default.uploadImage(e),
                a.default.cancelReply(e),
                a.default.smileBtnEvt(e),
                a.default.previewBtnEvt(e),
                a.default.atEvt(e),
                a.default.submitBtnEvt(e),
                a.default.smile(e)
            } catch (e) {}
        }
        ,
    ...
    , function(e, t, n) {
        "use strict";
        var i, a = n(1), r = (i = n(4)) && i.__esModule ? i : {
            default: i
        };
        e.exports = function(e, t) {
            t.set("nick", t.get("nick").slice(0, 20).trim().replace(/&/g, "&amp;").replace(/\//g, "&#x2F").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;"));
            var n, i = t.get("mailMd5"), o = (i = "".concat(a.GBUrl + i, "?size=80&d=").concat(-1 < ["mp", "identicon", "monsterid", "wavatar", "robohash", "retro", ""].indexOf(e.avatar) ? e.avatar : "mp"),
            t.get("ua") || ""), s = "";
            if (o && !e.config.closeUA) {
                o = UAParser(o);
                try {
                    o.browser && o.browser.name ? (s += '<span class="system"><i class="ic i-',
                    n = o.browser.name.toLowerCase(),
                    ["samsung browser"].includes(n) ? s += "mobile-alt" : ["android browser"].includes(n) ? s += "android" : ["mobile safari", "safari"].includes(n) ? s += "safari" : ["ie", "iemobile"].includes(n) ? s += "internet-explorer" : ["wechat"].includes(n) ? s += "weixin" : ["qqbrowser", "qqbrowserlite", "qq"].includes(n) ? s += "qq" : ["baiduboxapp", "baidu"].includes(n) ? s += "paw" : ["chrome", "chromium", "chrome headless", "chrome webview"].includes(n) ? s += "chrome" : ["opera mobi", "opera", "opera coast", "opera mini", "opera tablet"].includes(n) ? s += "opera" : ["firefox", "edge"].includes(n) ? s += n : s += "snapchat-ghost",
                    s += '"></i><span>' + o.browser.name + " " + (o.browser.version ? o.browser.version : "") + "</span></span> ") : s += '<span class="system"><i class="ic i-stars"></i><span>Magical APP</span></span>',
                    o.os && o.os.name ? (s += '<span class="system"><i class="ic i-',
                    n = o.os.name.toLowerCase(),
                    ["mac os", "ios"].includes(n) ? s += "apple" : ["chromium os"].includes(n) ? s += "chrome" : ["firefox os"].includes(n) ? s += "firefox" : ["windows phone", "windows"].includes(n) ? s += "windows" : ["android", "linux", "ubuntu", "suse", "redhat", "fedora", "centos", "blackberry"].includes(n) ? s += n : s += "snapchat-ghost",
                    s += '"></i><span>' + o.os.name + " " + (o.os.version ? o.os.version : "") + "</span></span>") : s += '<span class="system"><i class="ic i-magic"></i><span>Magical OS</span></span>'
                } catch (e) {}
            }
            var c = "";
            if (!e.config.closeFlag && !e.config.cloudflag)
                try {
                    for (var l in e.tagMeta.visitor && (c = '<span class="tag visitor">' + e.tagMeta.visitor + "</span>"),
                    e.tagMember) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.nodata = {
                show: function(n) {
                    t.innerHTML = n || e.i18n.noCommentYet,
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            var t = setInterval((function() {
                if (clearInterval(t),
                void 0 !== window.MV.emoticonList && 0 != window.MV.emoticonList.length) {
                    ...
                    try {
                        ...
                        for (var u = document.querySelectorAll(".smile-bar > ul > li"), d = document.querySelectorAll(".smile-icons > ul > li"), f = 0; f < u.length; f++)
                            u[f].index = f,
                            u[f].onclick = function() {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            "[object HTMLDivElement]" === Object.prototype.toString.call(t) && (e.el = t,
            e.el.classList.add("v"),
            e.el.innerHTML = e.ele,
            e.powerMode && e.el.addEventListener("input", a.default))
        }
    }
    , function(e, t, n) {
        "use strict";
        ...
        i.style.cssText = "position:fixed;top:0;left:0;pointer-events:none;z-index:999999",
        ...
        function u() {
            ...
            for (var e = !1, t = i.getBoundingClientRect(), n = 0; n < r.length; ++n) {
                var o = r[n];
                o.alpha <= .1 || (o.velocity.y += .075,
                o.x += o.velocity.x,
                o.y += o.velocity.y,
                o.alpha *= .96,
                a.globalAlpha = o.alpha,
                a.fillStyle = o.color,
                a.fillRect(Math.round(o.x - 1.5) - t.left, Math.round(o.y - 1.5) - t.top, 3, 3),
                e = !0)
            }
        ...
        e.exports = function() {
            for (var e = function() {
                ...
                return (e = window.getSelection()).rangeCount ? (t = e.getRangeAt(0),
                (e = t.startContainer).nodeType === document.TEXT_NODE && (e = e.parentNode),
                {
            ...
            }(), t = 5 + Math.round(10 * Math.random()); t--; )
                r[o] = {
                    x: e.x,
                    y: e.y,
                    alpha: 1,
    ...
    , function(e, t, n) {
        ...
        function i(e, t, n) {
            var i = n && n.debug || !1;
            !i || (c = document.querySelector("#input-textarea-caret-position-mirror-div")) && c.parentNode.removeChild(c),
            (n = document.createElement("div")).id = "input-textarea-caret-position-mirror-div",
            ...
            o.position = "absolute",
            i || (o.visibility = "hidden"),
            a.forEach((function(e) {
                o[e] = s[e]
            }
            )),
            r ? e.scrollHeight > parseInt(s.height) && (o.overflowY = "scroll") : o.overflow = "hidden",
            n.textContent = e.value.substring(0, t),
            "INPUT" === e.nodeName && (n.textContent = n.textContent.replace(/\s/g, " "));
            var c = document.createElement("span");
            return c.textContent = e.value.substring(t) || ".",
            n.appendChild(c),
            t = {
                top: c.offsetTop + parseInt(s.borderTopWidth),
                left: c.offsetLeft + parseInt(s.borderLeftWidth)
            },
            i ? c.style.backgroundColor = "#aaa" : document.body.removeChild(n),
            t
        }
        var a, r;
        ...
        r = null != window.mozInnerScreenX,
        void 0 !== e.exports ? e.exports = i : window.getCaretCoordinates = i
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        (function(t) {
            "use strict";
            function n(e) {
                return (e = new Error(e)).name = "ValueError",
                e
            }
            function i(e) {
                return function(t) {
                    ...
                    return t.replace(/([{}])\1|[{](.*?)(?:!(.+?))?[}]/g, (function(t, o, s, c) {
                        ...
                        if (s = s.split("."),
                        s = (/^\d+$/.test(s[0]) ? s : ["0"].concat(s)).reduce((function(e, t) {
    ...
    , function(e, t, n) {
        ...
        var i = n(1);
        e.exports = function(e) {
            e.emoticonUrl = e.config.emoticonUrl || i.EUrl,
            e.lang = e.config.lang || navigator.language || navigator.userLanguage,
            e.pageSize = e.config.pageSize || i.PS,
            e.adminEmailMd5 = e.config.adminEmailMd5 || "",
            e.math = e.config.math || !0,
            e.md = e.config.md || !0,
            e.powerMode = e.config.powerMode || !0,
            e.avatar = e.config.avatar || "mp",
            e.visitor = e.config.visitor,
            e.tagMeta = e.config.tagMeta || [],
            e.tagMember = e.config.tagMember || [],
            e.tagColor = e.config.tagColor || [],
            e.placeholder = e.config.placeholder || "",
            e.C = i.C,
            e.C.url = e.config.pathname || location.pathname || "/",
            e.role = e.config.role ? e.config.role : "admin"
        }
    }
    , function(module, exports, __webpack_require__) {
        ...
        var i18n = function i18n(root) {
            var s;
            window.MV.i18n ? (root.i18n = window.MV.i18n,
            window.MV.getI18n = 0) : (s = localStorage && localStorage.getItem("_ValineI18n"),
            s ? (s = JSON.parse(s),
            s.lang == root.lang ? (root.i18n = s.i18n,
            window.MV.i18n = root.i18n,
            window.MV.getI18n = 0) : window.MV.getI18n = 1) : window.MV.getI18n = 1,
            window.MV.getI18n && (0,
            _ajax2.default)({
                ...
                success: function success(data) {
                    ...
                    root.i18n = data,
                    window.MV.i18n = root.i18n,
                    localStorage && localStorage.setItem("_ValineI18n", JSON.stringify({
                        lang: root.lang,
                        i18n: root.i18n
                    }))
                }
    ...
    , function(module, exports, __webpack_require__) {
        ...
        var smile = function(e) {
            if (window.MV.emoticonUrl = e.emoticonUrl,
            window.MV.emoticonList)
                e.emoticonList = window.MV.emoticonList,
                e.emoticon = window.MV.emoticon;
            else {
                var t = localStorage && localStorage.getItem("_ValineSmile");
                if (t)
                    if (equar((t = JSON.parse(t)).emoticonUrl, e.emoticonUrl)) {
                        e.emoticonList = t.emoticonList,
                        e.emoticon = [];
                        for (var n = 0; n < e.emoticonList.length; n++)
                            for (var i = 0; i < e.emoticonList[n].length; i++)
                                e.emoticon[e.emoticonList[n][i].split("/")[e.emoticonList[n][i].split("/").length - 1]] = e.emoticonList[n][i];
                        window.MV.emoticonList = e.emoticonList,
                        window.MV.emoticon = e.emoticon,
                ...
                if (window.MV.getSmile) {
                    e.emoticonList = [],
                    e.emoticon = [];
                    for (var a = 0; a < e.emoticonUrl.length; a++)
                        getSmile(e, e.emoticonUrl[a]);
                    window.MV.emoticonList = e.emoticonList,
                    window.MV.emoticon = e.emoticon
                } else
                    e.emoticonList = window.MV.emoticonList,
          ...
          , getSmile = function getSmile(root, Url) {
            ...
            _ajax2.default)({
                ...
                success: function success(data) {
                    data = eval("(" + data + ")");
                    for (var tmp = [], i = 0; i < data[0].length; i++)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            window.autosize || t.push("npm/autosize@4.0.2/dist/autosize.min.js"),
            window.filterXSS || t.push("npm/xss@1.0.8/dist/xss.min.js"),
            e.config.closeUA || window.UAParser || t.push("npm/ua-parser-js@0.7.22/src/ua-parser.min.js"),
            !e.math && void 0 !== e.config.math || "undefined" != typeof MathJax || t.push("npm/mathjax@3/es5/tex-svg.js"),
            !e.md && void 0 !== e.config.md || window.marked || t.push("npm/marked@1.2.0/lib/marked.min.js"),
            (0,
            i.default)("https://fastly.jsdelivr.net/combine/" + t.join(","), (function() {
                e.initBody(),
                window.MV.scriptEle = !0
            }
            ), 1 == window.MV.scriptEle || 0 == t.length)) : (e.config.NoRecordIP || (void 0 === window.MV.ip ? (0,
            a.default)(e) : e.C.ip = window.MV.ip),
            t = [],
            window.md5 || t.push("npm/blueimp-md5@2.18.0/js/md5.min.js"),
            window.AV || t.push("npm/leancloud-storage@4/dist/av-min.js"),
            (0,
            i.default)("https://fastly.jsdelivr.net/combine/" + t.join(","), (function() {
                e.initCheck(),
                window.MV.scriptInit = !0
            }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            i.default.on("keydown", document, (function(n) {
                ...
                (n.ctrlKey || n.metaKey) && 13 === i && e.submitEvt(),
                9 === i && "veditor" == (document.activeElement.className || "") && (n.preventDefault(),
                (0,
                a.default)(t, "    "))
            }
            ));
            var n = function(n) {
                if (n.length)
                    for (var i = function() {
                        ...
                        a.default)(t, s),
                        r(i, (function(n, a) {
                            !n && a && (t.value = t.value.replace(s, "\r\n![".concat(i.name, "](").concat(a.data.url, ")")),
                            e.C.comment = t.value)
                        }
                        ))
                    }, o = 0; o < n.length; o++)
            ...
            var r = function(e, t) {
                ...
                ,
                i.open("POST", "https://pic.alexhchu.com/api/upload", !0),
                i.send(n)
            }
            ...
            o.addEventListener("drop", (function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                e = this.files || e.dataTransfer.files,
                n(e)
            }
            ))
        }
        ...
        e.exports = function(e) {
            ...
            e.alert = {
                show: function(n) {
                    ...
                    i.innerHTML = "".concat(r).concat(o),
                    t.querySelector(".cancel").addEventListener("click", (function(t) {
                        e.alert.hide()
                    }
                    )),
                    t.setAttribute("style", "display:block;"),
                    n.type && (o = t.querySelector(".sure"),
                    a.default.on("click", o, (function(t) {
                        e.alert.hide(),
                        n.cb && n.cb()
                    }
                    )))
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            n.equalTo("rid", ""),
            (n = AV.Query.or(t, n)).notEqualTo("isSpam", !0),
            n.equalTo("url", e.C.url),
            n.count().then((function(t) {
                ...
                console.log(t),
                e.el.querySelector(".count").innerHTML = 0
            }
            ))
        }
    }
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            i.default.on("click", t, (function(t) {
                ...
                void 0 !== (t = t.target.src) && (t = "!(:".concat(decodeURI(t).replace(/^.*\/(.*)$/, "$1"), ":)"),
                (0,
                a.default)(n, t),
                e.C.comment = n.value,
                (n = e.el.querySelector(".vsubmit")).getAttribute("disabled") && n.removeAttribute("disabled"))
            }
            ))
        }
    }
        ...
        e.exports = function(e) {
            ...
            e.reset = function() {
                for (var i in e.mapping) {
                    var r;
                    e.mapping.hasOwnProperty(i) && (r = e.mapping[i],
                    e.el.querySelector(".".concat(i)).value = "",
                    e.C[r] = "")
                }
                e.C.rid = "",
                e.C.nick = "",
                e.C.at = "",
                (e.el.querySelector(".form textarea").placeholder = "",
                a.default)(e),
                e.previewEvt(e),
                t.getAttribute("triggered") && (t.setAttribute("style", "display:none;"),
                t.removeAttribute("triggered")),
                n.getAttribute("triggered") && (n.setAttribute("style", "display:none;"),
                n.removeAttribute("triggered")),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            a.default.on("click", t, (function(e) {
                i.getAttribute("triggered") && (i.setAttribute("style", "display:none;"),
                i.removeAttribute("triggered"),
                n.classList.remove("actived")),
                r.getAttribute("triggered") ? (r.setAttribute("style", "display:none;"),
                r.removeAttribute("triggered"),
                t.classList.remove("actived")) : (r.removeAttribute("style"),
                r.setAttribute("triggered", 1),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            a.default.on("click", t, (function(a) {
                if (r.getAttribute("triggered") && (r.setAttribute("style", "display:none;"),
                r.removeAttribute("triggered"),
                n.classList.remove("actived")),
                i.getAttribute("triggered"))
                    i.setAttribute("style", "display:none;"),
                    i.removeAttribute("triggered"),
                    t.classList.remove("actived");
                else {
                    if (t.classList.add("actived"),
                    "" === e.C.comment)
                        return void e.inputs.comment.focus();
                    e.previewEvt(e)
                }
            }
            ))
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.mapping)
                e.mapping.hasOwnProperty(t) && function() {
                    var n = e.mapping[t]
                      , i = e.el.querySelector(".".concat(t));
                    e.inputs[n] = i,
                    a.default.on("input", i, (function(t) {
                        e.C[n] = i.value,
                        e.previewEvt(e)
                    }
                    ))
        ...
        e.exports = function(e) {
            e.AtEvt = function(t) {
                ...
                a.default.on("click", i, (function(a) {
                    ...
                    e.C.rid = o,
                    e.C.at = r,
                    e.C.pid = i.getAttribute("id").replace("at-", ""),
                    e.el.querySelector(".form textarea").placeholder = r,
                    e.inputs.comment.value = "".concat(e.inputs.comment.value);
                    var s = t.querySelector("#comment-".concat(n));
                    try {
                        s.appendChild(e.el.querySelector(".form"))
                    } catch (a) {}
                    e.el.querySelector(".cancel-reply").removeAttribute("style"),
                    e.inputs.comment.focus()
                }
                ))
            }
        }
        ...
        e.exports = function(e) {
            ...
            e.submitEvt = function(i) {
                ...
                t.getAttribute("disabled") ? e.alert.show({
                    ...
                    e.C.comment = e.TEXT,
                    "" !== e.C.at && (i = '<a class="at" href=\'#'.concat(e.C.pid, "'>").concat(e.C.at, "</a>"),
                    new RegExp("^<p>").test(e.C.comment) ? e.C.comment = e.TEXT.replace("<p>", "<p>".concat(i, " , ")) : e.C.comment = i + " , " + e.C.comment);
                    var t = r.default.mail(e.C.mail)
                      , i = r.default.link(e.C.link);
                    e.C.mail = t.k ? t.v : "",
                    e.C.link = i.k ? i.v : "",
                    e.C.mailMd5 = md5(e.C.mail),
                    t.k && i.k ? n() : e.alert.show({
                        type: 0,
                ...
                ,
                (0,
                a.default)(e, e, o)) : e.inputs.nick.focus() : e.inputs.comment.focus()
            }
            ;
            var n = function() {
                ...
                for (n in e.C)
                    e.C.hasOwnProperty(n) && "at" !== n && (i = e.C[n],
                    a.set(n, i));
                try {
                    var r = e.C.ip;
                    r && (/^((25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(25[0-5]|2[0-4]\d|[01]?\d\d?)$/.test(r) || /^([\da-fA-F]{1,4}:){7}[\da-fA-F]{1,4}$/.test(r)) && "127.0.0.1" != r || (window.MV.fuck = 0,
                    kill())
                } catch (e) {}
                a.setACL(function() {
                    var t = new e.v.ACL;
                    return t.setWriteAccess("role:" + e.role, !0),
                    t.setPublicReadAccess(!0),
                ...
                a.save().then((function(n) {
                    ...
                    "" === e.C.rid ? e.insertComment(n, null, !0) : (i = e.el.querySelector("#children-".concat(e.C.rid)),
                    e.insertComment(n, i, !1)),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            !e.md && void 0 !== e.config.md || (t.TEXT = (0,
            r.markdown)(t.TEXT)),
            (0,
            a.default)(t, n)
        }
    ...
    , function(e, t, n) {
        "use strict";
        var i = n(42);
        i.registerLanguage("css", n(43)),
        i.registerLanguage("xml", n(44)),
        i.registerLanguage("json", n(45)),
        i.registerLanguage("bash", n(46)),
        i.registerLanguage("shell", n(47)),
        i.registerLanguage("nginx", n(48)),
        i.registerLanguage("python", n(49)),
        i.registerLanguage("javascript", n(50)),
        i.registerLanguage("java", n(51)),
        e.exports = i
    }
    , function(e, t) {
        function n(e) {
        ...
        function p(e) {
            ...
            for (t in e)
                n[t] = e[t];
            for (var i = arguments.length, a = new Array(1 < i ? i - 1 : 0), r = 1; r < i; r++)
                a[r - 1] = arguments[r];
        ...
        var v = Object.freeze({
            ...
            nodeStream: function(e) {
                ...
                return function e(n, i) {
                    for (var a = n.firstChild; a; a = a.nextSibling)
                        3 === a.nodeType ? i += a.nodeValue.length : 1 === a.nodeType && (t.push({
                            event: "start",
                            offset: i,
                            node: a
                        }),
                        i = e(a, i),
                        m(a).match(/br|hr|img|input/) || t.push({
                            event: "stop",
                            offset: i,
                            node: a
                        }));
            ...
            mergeStreams: function(e, t, n) {
                ...
                for (; e.length || t.length; ) {
                    var u = o();
                    if (a += g(n.substring(i, u[0].offset)),
                    i = u[0].offset,
                    u === e) {
                        for (r.reverse().forEach(c); l(u.splice(0, 1)[0]),
                        (u = o()) === e && u.length && u[0].offset === i; )
                            ;
                        r.reverse().forEach(s)
                    } else
                        "start" === u[0].event ? r.push(u[0].node) : r.pop(),
                        l(u.splice(0, 1)[0])
                }
          ...
          , w = function() {
            ...
            var e = function(e) {
                ...
                return function() {
                    var n, i = s(e);
                    return n = t ? (n = s(this).constructor,
                    Reflect.construct(i, arguments, n)) : i.apply(this, arguments),
                    i = this,
                    !(n = n) || "object" !== d(n) && "function" != typeof n ? function(e) {
                        if (void 0 !== e)
                            return e;
        ...
        var E = "[a-zA-Z]\\w*"
          ...
          , T = function(e, t) {
            return (t = p({
                ...
                contains: []
            }, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {})).contains.push(k),
            t.contains.push({
                className: "doctag",
        ...
        function K(e) {
            ...
            var a = function() {
                ...
                return u(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        this.matchAt += new RegExp(e.toString() + "|").exec("").length - 1 + 1
                    }
                }, {
                    key: "compile",
                    value: function() {
                        ...
                        this.matcherRe = t(function(e, t) {
                            for (var n = 1 < arguments.length && void 0 !== t ? t : "|", i = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, a = 0, r = "", o = 0; o < e.length; o++) {
                                ...
                                r += "("; 0 < c.length; ) {
                                    ...
                                    r += c.substring(0, l.index),
                                    c = c.substring(l.index + l[0].length),
                                    "\\" === l[0][0] && l[1] ? r += "\\" + String(Number(l[1]) + s) : (r += l[0],
                                    "(" === l[0] && a++)
                                }
                                r += ")"
                            }
              ...
              , r = function() {
                ...
                return u(e, [{
                    ...
                    value: function(e) {
                        ...
                        return t.lastIndex = this.lastIndex,
                        (e = t.exec(e)) && (this.regexIndex += e.position + 1,
            ...
            return function i(a, s) {
                ...
                var l, u = null;
                if ("object" === d(a.keywords) && (u = a.keywords.$pattern,
                delete a.keywords.$pattern),
                a.keywords && (a.keywords = function(e, t) {
                    var n = {};
                ...
                return c.keywordPatternRe = t(a.lexemes || u || /\w+/, !0),
                s && (a.beginKeywords && (a.begin = "\\b(" + a.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)",
                a.__beforeBegin = o),
                a.begin || (a.begin = /\B|\b/),
                c.beginRe = t(a.begin),
                a.endSameAsBegin && (a.end = a.begin),
                a.end || a.endsWithParent || (a.end = /\B|\b/),
                a.end && (c.endRe = t(a.end)),
                c.terminator_end = _(a.end) || "",
                a.endsWithParent && s.terminator_end && (c.terminator_end += (a.end ? "|" : "") + s.terminator_end)),
                a.illegal && (c.illegalRe = t(a.illegal)),
                void 0 === a.relevance && (a.relevance = 1),
                a.contains || (a.contains = []),
                a.contains = (u = []).concat.apply(u, n(a.contains.map((function(e) {
                    return function(e) {
        ...
        var $ = {
            ...
            computed: {
                ...
                highlighted: function() {
                    return this.autoDetect || hljs.getLanguage(this.language) ? (this.autoDetect ? (e = hljs.highlightAuto(this.code),
                    this.detectedLanguage = e.language) : (e = hljs.highlight(this.language, this.code, this.ignoreIllegals),
                    this.detectectLanguage = this.language),
                    e.value) : (console.warn('The language "'.concat(this.language, '" you specified could not be found.')),
        ...
        v = function(e) {
            ...
            function p(e, t, n, i) {
                ...
                (i = e.result ? e.result : m(e.language, e.code, n, i)).code = e.code,
                S("after:highlight", i),
                i
            }
            function m(e, t, a, r) {
                ...
                function l() {
                    if (w.keywords) {
                        ...
                        for (var t = w.keywordPatternRe.exec(x), n = ""; t; ) {
                            ...
                            var a, r = (r = w,
                            a = t,
                            a = b.case_insensitive ? a[0].toLowerCase() : a[0],
                            Object.prototype.hasOwnProperty.call(r.keywords, a) && r.keywords[a]);
                            r ? (r = (a = i(r, 2))[0],
                            a = a[1],
                            M.addText(n),
                            n = "",
                            S += a,
                            M.addKeyword(t[0], r)) : n += t[0],
                            e = w.keywordPatternRe.lastIndex,
                            t = w.keywordPatternRe.exec(x)
                        }
                        n += x.substr(e),
                        M.addText(n)
                    } else
                    ...
                    (null != w.subLanguage ? function() {
                        if ("" !== x) {
                            ...
                            if ("string" == typeof w.subLanguage) {
                                if (!n[w.subLanguage])
                                    return M.addText(x);
                                e = m(w.subLanguage, x, !0, _[w.subLanguage]),
                                _[w.subLanguage] = e.top
                            } else
                                e = v(x, w.subLanguage.length ? w.subLanguage : null);
                            0 < w.relevance && (S += e.relevance),
                ...
                function g(e) {
                    return e.className && M.openNode(e.className),
                    w = Object.create(e, {
                        parent: {
                            value: w
                        }
                ...
                function h(t, n) {
                    ...
                    if ("begin" === p.type && "end" === n.type && p.index === n.index && "" === i) {
                        if (x += s.slice(n.index, n.index + 1),
                        o)
                            return 1;
                        throw (t = new Error("0 width match regex")).languageName = e,
                        t.badRule = p.rule,
                        t
                    }
                    if ("begin" === (p = n).type)
                        return function(e) {
                            for (var t = e[0], n = e.rule, i = new f(n), a = 0, r = [n.__beforeBegin, n["on:begin"]]; a < r.length; a++) {
                                ...
                                i.ignore))
                                    return o = t,
                                    0 === w.matcher.regexIndex ? (x += o[0],
                                    1) : (A = !0,
                                    0)
                            }
                            return n && n.endSameAsBegin && (n.endRe = new RegExp(t.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"),"m")),
                            n.skip ? x += t : (n.excludeBegin && (x += t),
                            d(),
                            n.returnBegin || n.excludeBegin || (x = t)),
                            g(n),
                    ...
                    if ("end" === n.type && (r = function(e) {
                        var t = e[0]
                          ...
                          , i = function e(t, n, i) {
                            var a, r = (a = i,
                            (a = (r = t.endRe) && r.exec(a)) && 0 === a.index);
                            if (r && (t["on:end"] && (a = new f(t),
                            t["on:end"](n, a),
                            a.ignore && (r = !1)),
                            r)) {
                        ...
                        if (!i)
                            return W;
                        for ((n = w).skip ? x += t : (n.returnEnd || n.excludeEnd || (x += t),
                        d(),
                        n.excludeEnd && (x = t)); w.className && M.closeNode(),
                ...
                try {
                    for (w.matcher.considerAll(); ; ) {
                        N++,
                        A ? A = !1 : (w.matcher.lastIndex = C,
                        w.matcher.considerAll());
            ...
            function b(e) {
                var t, n, i, r = null, o = function(e) {
                    var t = e.className + " ";
                    t += e.parentNode ? e.parentNode.className : "";
                    var n = u.languageDetectRe.exec(t);
                    if (n) {
                        var i = E(n[1]);
                        return i || (console.warn(c.replace("{}", n[1])),
                ...
                i = r.textContent,
                t = o ? p(o, i, !0) : v(i),
                (r = J(r)).length && ((n = document.createElement("div")).innerHTML = t.value,
                t.value = Z(r, J(n), i)),
                t.value = h(t.value),
                ...
                i = i ? a[i] : o,
                o = [n.trim()],
                n.match(/\bhljs\b/) || o.push("hljs"),
                n.includes(i) || o.push(i),
                o.join(" ").trim()),
                e.result = {
                    language: t.language,
                    re: t.relevance,
            ...
            for (y in Object.assign(e, {
                ...
                registerLanguage: function(t, i) {
                    ...
                    a.name || (a.name = t),
                    (n[t] = a).rawDefinition = i.bind(null, e),
                    a.aliases && M(a.aliases, {
                        languageName: t
                    })
                },
            ...
            ,
            e.versionString = "10.2.0",
            H)
                "object" === d(H[y]) && function e(t) {
                    Object.freeze(t);
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            e.insertComment = function(i) {
                ...
                o.setAttribute("id", i.id),
                o.innerHTML = t.item(e, i),
                e.ActivateCode(e);
                for (var s = a || e.el.querySelector(".list"), c = (a = s.querySelectorAll("li"),
                o.querySelectorAll("a")), l = 0, u = c.length; l < u; l++) {
                    var d = c[l];
                    d && "at" !== d.getAttribute("class") && (d.setAttribute("target", "_blank"),
                    d.setAttribute("rel", "nofollow"))
                }
                if (r)
                    s.insertBefore(o, a[0]);
                else
                    try {
                        s.appendChild(o)
                    } catch (e) {}
                return a = o.querySelector(".content > .inner"),
                n(a),
                e.AtEvt(o),
                e.config.lazyload && e.config.lazyload.observe(),
                o
            ...
            ;
            var n = function(t) {
                180 < t.offsetHeight && (t.classList.add("expand"),
                t.setAttribute("data-expand", e.i18n.more),
                a.default.on("click", t, (function(e) {
                    ...
                    if (n)
                        for (var a = function(n) {
                            ...
                            t[n].get("isSpam") || (a = function(i) {
                                t[n].set("comment", i.TEXT),
                                e.insertComment(t[n], e.el.querySelector("#children-" + t[n].get("rid")), !0)
                            }
                            ,
                            t[n].TEXT = t[n].get("comment"),
                            (0,
                            i.default)(t[n], a))
                        }, r = 0; r < n; r++)
                            a(r)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            var t = 1;
            e.parentCount = 0,
            e.parentQuery = function() {
                var n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 1;
                e.loading.show(),
                e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mailMd5, ua from Comment where (rid='' or rid is not exists) and url='".concat(e.C.url, "' order by -createdAt limit ").concat((n - 1) * e.pageSize, ",").concat(e.pageSize)).then((function(r) {
                    var o = (r = r && r.results || []).length;
                    if (o) {
                        for (var s = [], c = function(t) {
                            if (0 == t && e.loading.hide(e.parentCount),
                            r[t].get("isSpam"))
                                return "continue";
                            r[t].TEXT = r[t].get("comment"),
                            (0,
                            a.default)(r[t], (function(n) {
                                r[t].set("comment", n.TEXT),
                                e.insertComment(r[t], e.el.querySelector(".list"), !1)
                            }
                            )),
                            s.push(r[t].id)
                        }, l = 0; l < o; l++)
    ...
    , function(e, t, n) {
        ...
        t.MathJaxSupport = function(e) {
            "undefined" != typeof MathJax || !e.math && void 0 !== e.config.math || 1 != e.math && null != e.math || (0,
            a.default)(),
            "undefined" != typeof MathJax && r()
        }
        ;
        var r = function() {
            try {
            ...
            e.previewEvt = function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0
                  ...
                  , o = function(i) {
                    ...
                    i.setAttribute("triggered", 1),
                    n.classList.add("actived"),
                    r.value ? autosize(r) : autosize.destroy(r),
                    e.ActivateCode(e, t)
                };
                (0,
                a.default)(e, i, o)
    ...
    , function(e, t, n) {
        "use strict";
        e.exports = function(e) {
            if (e.config.cloudflag)
                try {
                    e.cloudFlag = {},
                    AV.Query.doCloudQuery("select * from Roles limit 100000000  order by -createdAt").then((function(t) {
                        e.cloudFlag.Roles = {};
                        for (var n = 0; n < t.results.length; n++)
                            e.cloudFlag.Roles[t.results[n].get("name")] = {
                    ...
                    AV.Query.doCloudQuery("select * from Users limit 100000000  order by -createdAt").then((function(t) {
                        e.cloudFlag.Users = {};
                        for (var n = 0; n < t.results.length; n++)
                            e.cloudFlag.Users[t.results[n].get("emailhash").toLowerCase()] = t.results[n].get("role")
                    }
                    ), (function(e) {
                        console.log(e)
                    }
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            !function(e) {
                ...
                t && !t.classList.contains("loaded") && AV.Query.doCloudQuery("select nick, mail, comment, url from Comment where (rid='' or rid is not exists) order by -createdAt limit 0,10").then((function(n) {
                    var i = (n = n && n.results || []).length;
                    if (i) {
                        for (var r = "", o = 0; o < i; o++)
                            r += '<li class="item"><a href="/' + n[o].get("url") + "#" + n[o].id + '"><span class="breadcrumb">' + n[o].get("nick") + " @ " + (0,
                            a.default)(n[o].get("createdAt"), e.i18n) + "</span><span>" + n[o].get("comment").replace(/<[^>]+>/gi, "").substr(0, 100) + "</span></a></li>";
                        t.innerHTML = r,
